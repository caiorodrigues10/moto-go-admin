...
export default function AdminUsersPage() {
      ...
      case "role":
        return (
          <div className="flex flex-col">
            ...
            <p className="text-bold text-sm capitalize text-zinc-400">
              {user.team}
            </p>
          </div>
        );
        ...
        return (
          <div className="relative flex items-center justify-center gap-2">
            <Tooltip content="Details">
              <span className="text-lg text-zinc-300 cursor-pointer active:opacity-50">
                <Eye />
              </span>
            </Tooltip>
  ...
  const classNames = useMemo(
    () => ({
        // "base" ｜ "table" ｜ "thead" ｜ "tbody" ｜ "tfoot" ｜ "emptyWrapper" ｜ "loadingWrapper" ｜ "wrapper" ｜ "tr" ｜ "th" ｜ "td" ｜ "sortIcon",
      th: ["bg-[#151C27]"],
      tr: ["data-[odd=true]:bg-[#425269]"],
      wrapper: ['bg-[#2B3544]', 'w-full'],
      base: "max-w-7xl"
    }),
    [],
  );
